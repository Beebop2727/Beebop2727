...
My work spans both software and infrastructure, from developing web and augmented reality projects to building a dual-GPU Proxmox workstation and cyber lab with isolated Linux, Windows, and Parrot OS environments.

The Proxmox project reached **V2** and is now complete. My current infrastructure work is moving the useful virtualisation and security-lab concepts from that project to a **bare-metal Ryoku Linux workstation**, using KVM/QEMU, libvirt, VFIO, and GPU passthrough.
...
| [**spotify-control-centre**](https://github.com/Beebop2727/spotify-control-centre) | spotify control centre forked from two different repos, currently only compatible with Ubuntu | JavaScript | 2026-08-02 |
<!-- RECENT-REPOS:END -->
...
| ---------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------- |
| [**proxmox-workstation-platform**](https://github.com/Beebop2727/proxmox-workstation-platform) | Completed V2 workstation and personal cyber lab with dual-GPU passthrough, Windows/Linux VMs, Looking Glass, OPNsense, WireGuard, monitoring, and isolated security environments | Proxmox, Linux, KVM/QEMU, VFIO, OPNsense |
...
The **Proxmox Workstation Platform** reached V2 and is now complete as a documented engineering experiment.
...
The next project keeps the useful virtualisation concepts while returning the primary Linux desktop to bare metal.
...
The Ryoku build will continue using **VFIO and GPU passthrough** for workloads that benefit from virtualisation without making the workstation itself a dedicated hypervisor.

A dedicated repository for the Ryoku platform is forthcoming.
